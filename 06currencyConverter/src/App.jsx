...
function App() {
  ...
  return (
        <div
            ...
            style={{
                backgroundImage: `url('https://images.pexels.com/photos/27977046/pexels-photo-27977046.jpeg')`,
            }}
        >
            <h1 className='text-2xl mb-0 border border-gray-60 rounded-lg p-5 backdrop-blur-sm bg-white/30'>Currency Converter App</h1>
