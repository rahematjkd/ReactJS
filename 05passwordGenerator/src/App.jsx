...
function App() {
  ...
  const copyPasswordToClipboard = useCallback(() => {
    ...
    // passwordRef.current?.setSelectionRange(0, 3); selects texts only 3 chars
  ...
  return (
    <>
      <div className='w-full max-w-md mx-auto shadow-md rounded-lg px-4 my-9  bg-gray-800 text-orange-500'>
